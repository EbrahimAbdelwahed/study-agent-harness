...
and the next dependency-ready slice. The current pickup is TUT-03B2
authority-bound capability gateway. Preserve the per-course event stream as canonical, keep next
