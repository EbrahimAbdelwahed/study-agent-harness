...
class EvidenceCatalog:
    """Immutable bindings that are both indexable and canonical-resolution capable."""
...
class EvidenceService:
    ...
    def _expansion(
        ...
        citation, text = self._citation(binding)
    ...
    def _resolved_row(
        ...
        *,
        ...
        return EvidenceRow(
            ...
            score,
            tuple(retrievers),
            binding.projection.projector_name,
            binding.projection.projector_version,
            expansions,
        )
