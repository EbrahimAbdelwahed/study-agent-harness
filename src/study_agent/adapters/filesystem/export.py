...
from study_agent.application.export import EXPORT_SCHEMA_VERSION, ExportBundle
...
class FilesystemExportWriter:
    ...
    def write(self, bundle: ExportBundle, destination: Path) -> ExportReceipt:
...
def _export_files(bundle: ExportBundle) -> Mapping[str, bytes]:
    data_files = {
