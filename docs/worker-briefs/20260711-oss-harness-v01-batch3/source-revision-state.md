# Worker Brief: source-revision-state

## Assignment

Implement `source-revision-state` from `docs/specs/oss-harness-v0-1-immutable-text-ingestion.md`.

Task title: source-revision-state Implement typed source-revision events and replayable projections
...
- `docs/worker-profiles/source-state-worker.md`
