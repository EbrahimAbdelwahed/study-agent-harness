# Worker Brief: reference-cli-commands

## Assignment

Implement `reference-cli-commands` from `<spec path>`.

Task title: reference-cli-commands Implement reference CLI commands and JSON boundary
...
- `docs/worker-profiles/reference-cli-worker.md`
