# Worker Brief: deterministic-export

## Assignment

Implement `deterministic-export` from `<spec path>`.

Task title: deterministic-export Implement deterministic credential-free export v1
...
- `docs/worker-profiles/deterministic-export-worker.md`
