# Worker Brief: cli-persistence-prerequisites

## Assignment

Implement `cli-persistence-prerequisites` from `<spec path>`.

Task title: cli-persistence-prerequisites Add durable run state, system clock, and catalog reads
...
- `docs/worker-profiles/cli-persistence-worker.md`
