# Worker Brief: fts-retrieval

## Assignment

Implement `fts-retrieval` from `docs/specs/oss-harness-v0-1-lexical-retrieval-and-citations.md`.

Task title: fts-retrieval Implement portable SQLite FTS5 lexical retrieval
...
- `docs/worker-profiles/sqlite-fts-retrieval-worker.md`
