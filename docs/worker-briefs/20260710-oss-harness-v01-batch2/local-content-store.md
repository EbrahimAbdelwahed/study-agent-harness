# Worker Brief: local-content-store

## Assignment

Implement `local-content-store` from `docs/specs/oss-harness-v0-1-content-and-execution-spine.md`.

Task title: local-content-store Implement immutable filesystem content-addressed storage
...
- `docs/worker-profiles/content-addressed-storage-worker.md`
