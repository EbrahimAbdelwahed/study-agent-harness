# Worker Brief: event-state-kernel

## Assignment

Implement `event-state-kernel` from `docs/specs/oss-study-agent-harness-v0-1.md`.

Task title: event-state-kernel Implement the event-sourced SQLite state kernel
...
- `docs/worker-profiles/event-state-kernel-worker.md`
