# Worker Brief: trusted-run-receipts

## Assignment

Implement `trusted-run-receipts` from `docs/specs/oss-harness-v0-1-event-sourced-sessions-and-provenance.md`.

Task title: trusted-run-receipts Expose trusted retrieval, validator, and recovered-run receipts
...
- `docs/worker-profiles/run-receipt-worker.md`
