# Worker Brief: session-event-kernel

## Assignment

Implement `session-event-kernel` from `docs/specs/oss-harness-v0-1-event-sourced-sessions-and-provenance.md`.

Task title: session-event-kernel Implement typed event-sourced session state
...
- `docs/worker-profiles/session-state-worker.md`
