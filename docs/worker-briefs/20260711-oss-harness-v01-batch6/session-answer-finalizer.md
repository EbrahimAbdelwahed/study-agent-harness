# Worker Brief: session-answer-finalizer

## Assignment

Implement `session-answer-finalizer` from `docs/specs/oss-harness-v0-1-event-sourced-sessions-and-provenance.md`.

Task title: session-answer-finalizer Finalize verified grounded runs into sessions atomically
...
- `docs/worker-profiles/session-finalization-worker.md`
