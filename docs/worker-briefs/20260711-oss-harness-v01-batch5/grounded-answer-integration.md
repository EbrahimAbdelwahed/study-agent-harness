# Worker Brief: grounded-answer-integration

## Assignment

Implement `grounded-answer-integration` from `docs/specs/oss-harness-v0-1-grounded-answer-and-model-adapters.md`.

Task title: grounded-answer-integration Integrate canonical prompts and grounded answers through the generic engine
...
- `docs/worker-profiles/grounded-answer-integration-worker.md`
