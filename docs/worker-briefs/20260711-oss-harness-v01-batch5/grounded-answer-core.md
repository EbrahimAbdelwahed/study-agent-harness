# Worker Brief: grounded-answer-core

## Assignment

Implement `grounded-answer-core` from `docs/specs/oss-harness-v0-1-grounded-answer-and-model-adapters.md`.

Task title: grounded-answer-core Implement the portable grounded-answer behavior package
...
- `docs/worker-profiles/grounding-prompt-worker.md`
