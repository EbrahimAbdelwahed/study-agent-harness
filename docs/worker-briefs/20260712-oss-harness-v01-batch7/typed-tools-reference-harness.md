# Worker Brief: typed-tools-reference-harness

## Assignment

Implement `typed-tools-reference-harness` from `docs/specs/oss-harness-v0-1-typed-tools-and-reference-harness.md`.

Task title: typed-tools-reference-harness Implement exact typed tools and reference harness
...
- `docs/worker-profiles/typed-tool-harness-worker.md`
