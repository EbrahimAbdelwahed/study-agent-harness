# Worker Brief: course-profile-kernel

## Assignment

Implement `course-profile-kernel` from `docs/specs/oss-harness-v0-1-typed-tools-and-reference-harness.md`.

Task title: course-profile-kernel Implement immutable canonical course profiles
...
- `docs/worker-profiles/course-state-worker.md`
