# Worker Brief: grounding-ask-service

## Assignment

Implement `grounding-ask-service` from `docs/specs/oss-harness-v0-1-typed-tools-and-reference-harness.md`.

Task title: grounding-ask-service Implement the canonical grounded ask use case
...
- `docs/worker-profiles/grounding-ask-worker.md`
