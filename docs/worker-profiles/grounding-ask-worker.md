# Worker Profile: grounding-ask-worker

Generated: 2026-07-12
Source task: `docs/tasks/20260712-oss-harness-v01-batch7/grounding-ask-service.md`

## Reuse Trigger

Use this worker when a bead has the same implementation shape as `grounding-ask-service Implement the canonical grounded ask use case`.

## Mandate

Complete recurring work shaped like `grounding-ask-service` without redesigning the feature.
...
- `docs/tasks/20260712-oss-harness-v01-batch7/grounding-ask-service.md`
