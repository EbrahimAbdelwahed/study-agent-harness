# Worker Profile: deterministic-export-worker

Generated: 2026-07-12
Source task: `docs/tasks/20260712-oss-harness-v01-batch8/deterministic-export.md`

## Reuse Trigger

Use this worker when a bead has the same implementation shape as `deterministic-export Implement deterministic credential-free export v1`.

## Mandate

Complete recurring work shaped like `deterministic-export` without redesigning the feature.
...
- `docs/tasks/20260712-oss-harness-v01-batch8/deterministic-export.md`
